...
app.config["MYSQL_PASSWORD"] = "Farhan@123#!%"
app.config["MYSQL_DB"] = 'orange-detection-app-db'
...
def register():
    ...
    cur.execute("INSERT INTO users (first_name, last_name, email, contact, password, confirm_password) VALUES (%s, %s, %s, %s, %s, %s)", (first_name, last_name, email, contact, password, confirm_password))
